...
import ComposeManagement from "./pages/ComposeManagement.vue";
import ContainerTerminal from "./pages/ContainerTerminal.vue";
import DockerBridge from "./pages/DockerBridge.vue";
                ...
                children: [
                    {
                        ...
                        children: [
                            ...
                            {
                                path: "/compose-management",
                                component: ComposeManagement,
                            },
                            {

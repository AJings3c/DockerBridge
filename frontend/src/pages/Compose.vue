        ...
        <div class="compose-page">
            <div class="compose-heading">
                <div>
                    ...
                    <div v-if="$root.agentCount > 1 && endpoint !== ''" class="agent-name">
                        {{ endpointDisplay }}
                    </div>
                    <div v-if="stack.isDiscoveredCompose && stack.composeFilePath" class="compose-source">
                        <font-awesome-icon icon="file" class="me-1" />
                        {{ stack.composeFilePath }}
                    </div>
                </div>

                <div v-if="stack.isManagedByDockge" class="action-toolbar">
                    ...
                    <button v-if="!isEditMode && !stack.isDiscoveredCompose" class="btn btn-danger" :disabled="processing" @click="showDeleteDialog = !showDeleteDialog">
            ...
            <!-- URLs -->
            <div v-if="urls.length > 0" class="url-strip">
            ...
            <div v-if="stack.isManagedByDockge" class="compose-workspace">
            ...
            <div v-if="!stack.isManagedByDockge && !processing" class="shadow-box unmanaged-panel">
